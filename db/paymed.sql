...
INSERT INTO `bancos` (`id_ban`, `cod_ban`, `banco`, `nacional`, `id_sta`) VALUES
(1, '0102', 'BANCO DE VENEZUELA', 1, 1),
(2, '0108', 'PROVINCIAL', 1, 1),
(3, '0000', 'BANESCO PANAMA', 0, 1);
...
CREATE TABLE `datos_bancarios_med` (
  ...
  `ach` varchar(100) DEFAULT NULL,
  `swit` varchar(100) DEFAULT NULL,
  `aba` varchar(100) DEFAULT NULL,
  `id_sta` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `datos_bancarios_med`
--

INSERT INTO `datos_bancarios_med` (`id`, `id_user`, `id_ban`, `id_tip`, `nro_cuenta`, `ach`, `swit`, `aba`, `id_sta`) VALUES
(1, 2, 1, 1, '010878768465456464', '0', '0', '0', 1),
(2, 2, 3, 2, '234234234234234', '234234234234234', '4444444444', '55555555555', 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `especialidades_med`
--
...
--
-- Volcado de datos para la tabla `especialidades_med`
--

INSERT INTO `especialidades_med` (`id_espe`, `especialidad`, `id_sta`) VALUES
(1, 'PEDIATRIA', 1),
(2, 'TRAUMATOLOGIA', 1),
(3, 'GINECOLOGIA', 1);
...
INSERT INTO `estadocivil` (`id_civ`, `civil`, `id_sta`) VALUES
(1, 'CASADO', 1),
(2, 'SOLTERO', 1),
(3, 'DIVORCIADO', 1),
(4, 'VIUDO', 1);
...
INSERT INTO `estados` (`id_estado`, `estado`, `iso_3166-2`, `idpais`) VALUES
(1, 'Amazonas', 'VE-X', 1),
(2, 'Anzoátegui', 'VE-B', 1),
(3, 'Apure', 'VE-C', 1),
(4, 'Aragua', 'VE-D', 1),
...
(14, 'Miranda', 'VE-M', 1),
(15, 'Monagas', 'VE-N', 1),
(16, 'Nueva Esparta', 'VE-O', 1),
(17, 'Portuguesa', 'VE-P', 1),
(18, 'Sucre', 'VE-R', 1),
(19, 'Táchira', 'VE-S', 1),
(20, 'Trujillo', 'VE-T', 1),
(21, 'Vargas', 'VE-W', 1),
(22, 'Yaracuy', 'VE-U', 1),
(23, 'Zulia', 'VE-V', 1),
(24, 'Distrito Capital', 'VE-A', 1),
(25, 'Dependencias Federales', 'VE-Z', 1);
...
INSERT INTO `estatus` (`id_sta`, `nom_sta`) VALUES
(1, 'ACTIVO'),
(2, 'INACTIVO'),
(3, 'BLOQUEADO'),
(4, 'DEUDOR');
...
CREATE TABLE `logs` (
  ...
  `status` enum('success','error','warning') DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Estructura de tabla para la tabla `medico_clinicas`
--
...
CREATE TABLE `medico_clinicas` (
  ...
  `pac_dia` int(11) NOT NULL,
  `pac_aseg` int(11) DEFAULT NULL,
  `pac_part` int(11) DEFAULT NULL,
  `consul` varchar(50) DEFAULT NULL,
...
--
-- Volcado de datos para la tabla `medico_clinicas`
--
...
INSERT INTO `pais` (`id`, `pais`, `id_sta`) VALUES
(1, 'VENEZUELA', 1),
(2, 'COLOMBIA', 1);
...
INSERT INTO `sexo` (`id_sex`, `genero`, `id_sta`) VALUES
(1, 'MASCULINO', 1),
(2, 'FEMENINO', 1);
...
INSERT INTO `tipoempresa` (`id`, `id_tip`, `tip_empresa`, `id_sta`) VALUES
(1, 1, 'PRIVADA', 1),
(2, 2, 'GUBERNAMENTAL', 1);
...
INSERT INTO `tipoproveedor` (`id`, `tipo_prove`, `id_sta`) VALUES
(1, 'CLINICA', 1),
(2, 'CENTRO AMBULATORIO', 1),
(3, 'CENTRO DE APS', 1),
(4, 'CENTRO OFTALMOLOGICO', 1),
(5, 'CLINICA + APS', 1);
...
INSERT INTO `tipo_cuenta_banco` (`id`, `tipo_cuenta`, `id_sta`) VALUES
(1, 'CORRIENTE', 1),
(2, 'AHORRO', 1);
...
--
-- Estructura de tabla para la tabla `users_privilegios`
--

CREATE TABLE `users_privilegios` (
  `id_upri` int(11) NOT NULL,
  `id_user` int(11) NOT NULL,
  `id_pri` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `users_privilegios`
--

INSERT INTO `users_privilegios` (`id_upri`, `id_user`, `id_pri`) VALUES
(1, 1, 1),
(2, 2, 6);
...
--
-- Indices de la tabla `datos_bancarios_med`
--
...
--
-- Indices de la tabla `especialidades_med`
--
...
ALTER TABLE `medicos`
  ...
  ADD UNIQUE KEY `correo_pri` (`correo_pri`),
  ADD UNIQUE KEY `cod_col_med` (`cod_col_med`),
  ADD UNIQUE KEY `mpss` (`mpss`),
  ADD UNIQUE KEY `correo2` (`correo2`),
  ADD KEY `id_sta` (`id_sta`),
  ADD KEY `id_user` (`id_user`);

--
-- Indices de la tabla `medico_clinicas`
--
...
--
-- Indices de la tabla `users_privilegios`
--
ALTER TABLE `users_privilegios`
  ADD PRIMARY KEY (`id_upri`),
...
ALTER TABLE `users_status`
  ADD PRIMARY KEY (`id_usta`,`id_user`),
  ADD KEY `id_sta` (`id_sta`),
  ADD KEY `id_user` (`id_user`);
...
--
-- AUTO_INCREMENT de la tabla `especialidades_med`
--
ALTER TABLE `especialidades_med`
  MODIFY `id_espe` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `estadocivil`
--
ALTER TABLE `estadocivil`
  MODIFY `id_civ` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
-- AUTO_INCREMENT de la tabla `users_privilegios`
--
ALTER TABLE `users_privilegios`
  MODIFY `id_upri` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `users_status`
--
ALTER TABLE `users_status`
  MODIFY `id_usta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `bancos`
  ADD CONSTRAINT `bancos_ibfk_1` FOREIGN KEY (`id_sta`) REFERENCES `estatus` (`id_sta`);
...
--
ALTER TABLE `clinicas`
  ADD CONSTRAINT `clinicas_ibfk_1` FOREIGN KEY (`id_tip`) REFERENCES `tipoempresa` (`id`),
  ADD CONSTRAINT `clinicas_ibfk_2` FOREIGN KEY (`id_pro`) REFERENCES `tipoproveedor` (`id`),
...
--
ALTER TABLE `datos_bancarios_med`
  ADD CONSTRAINT `datos_bancarios_med_ibfk_1` FOREIGN KEY (`id_sta`) REFERENCES `estatus` (`id_sta`),
  ADD CONSTRAINT `datos_bancarios_med_ibfk_2` FOREIGN KEY (`id_user`) REFERENCES `users` (`id_user`),
  ADD CONSTRAINT `datos_bancarios_med_ibfk_3` FOREIGN KEY (`id_ban`) REFERENCES `bancos` (`id_ban`),
  ADD CONSTRAINT `datos_bancarios_med_ibfk_4` FOREIGN KEY (`id_tip`) REFERENCES `tipo_cuenta_banco` (`id`);

--
-- Filtros para la tabla `especialidades_med`
--
ALTER TABLE `especialidades_med`
  ADD CONSTRAINT `especialidades_med_ibfk_1` FOREIGN KEY (`id_sta`) REFERENCES `estatus` (`id_sta`);

--
-- Filtros para la tabla `estadocivil`
--
ALTER TABLE `estadocivil`
  ADD CONSTRAINT `estadocivil_ibfk_1` FOREIGN KEY (`id_sta`) REFERENCES `estatus` (`id_sta`);

--
-- Filtros para la tabla `medicos`
--
ALTER TABLE `medicos`
  ADD CONSTRAINT `medicos_ibfk_2` FOREIGN KEY (`id_sta`) REFERENCES `estatus` (`id_sta`),
  ADD CONSTRAINT `medicos_ibfk_3` FOREIGN KEY (`id_user`) REFERENCES `users` (`id_user`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `medico_clinicas`
--
ALTER TABLE `medico_clinicas`
  ADD CONSTRAINT `medico_clinicas_ibfk_1` FOREIGN KEY (`id_cli`) REFERENCES `clinicas` (`id_cli`),
  ADD CONSTRAINT `medico_clinicas_ibfk_2` FOREIGN KEY (`id_med`) REFERENCES `medicos` (`id_user`),
...
--
ALTER TABLE `pais`
  ADD CONSTRAINT `pais_ibfk_1` FOREIGN KEY (`id_sta`) REFERENCES `estatus` (`id_sta`);
...
--
ALTER TABLE `sexo`
  ADD CONSTRAINT `sexo_ibfk_1` FOREIGN KEY (`id_sta`) REFERENCES `estatus` (`id_sta`);

--
-- Filtros para la tabla `tipoempresa`
--
ALTER TABLE `tipoempresa`
  ADD CONSTRAINT `tipoempresa_ibfk_1` FOREIGN KEY (`id_sta`) REFERENCES `estatus` (`id_sta`);

--
-- Filtros para la tabla `tipoproveedor`
--
ALTER TABLE `tipoproveedor`
  ADD CONSTRAINT `tipoproveedor_ibfk_1` FOREIGN KEY (`id_sta`) REFERENCES `estatus` (`id_sta`);

--
-- Filtros para la tabla `tipo_cuenta_banco`
--
ALTER TABLE `tipo_cuenta_banco`
  ADD CONSTRAINT `tipo_cuenta_banco_ibfk_1` FOREIGN KEY (`id_sta`) REFERENCES `estatus` (`id_sta`);

--
-- Filtros para la tabla `users_privilegios`
--
ALTER TABLE `users_privilegios`
  ADD CONSTRAINT `users_privilegios_ibfk_2` FOREIGN KEY (`id_pri`) REFERENCES `privilegios` (`id_pri`),
  ADD CONSTRAINT `users_privilegios_ibfk_3` FOREIGN KEY (`id_user`) REFERENCES `users` (`id_user`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `users_status`
--
ALTER TABLE `users_status`
  ADD CONSTRAINT `users_status_ibfk_2` FOREIGN KEY (`id_sta`) REFERENCES `estatus` (`id_sta`),
  ADD CONSTRAINT `users_status_ibfk_3` FOREIGN KEY (`id_user`) REFERENCES `users` (`id_user`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
