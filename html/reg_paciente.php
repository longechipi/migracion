            ...
            <div class="card-body">
                ...
                <form id="reg_med">
                    <input type="text" name="id_user" id="id_user" value="<?php echo $id_user; ?>" hidden />
                     ...
                     <div class="divider">
                        <div class="divider-text">Datos Básicos</div>
                      </div>

                      <div class="col-md-2">
                            <div class="form-group">
                            <label for="num_hist">Historia</label>
                            <input type="text" name="num_hist" id="num_hist" class="form-control" value="2400002" required readonly/>
                            </div>
                        </div>
                      ...
                      <div class="col-md-2 mb-4">
                            <div class="form-group">
                                <label for="menor">¿Paciente sin Cédula?</label>
                                <select name="menor" id="menor" class="form-select" required>
                      ...
                      <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="nrodoc" id="nrodoc" minlength="6" maxlength="9" onblur="busci(this.value)" onkeypress="return numeros(this, event);" class="form-control" required>
                            </div>
                        </div>
