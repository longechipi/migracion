									...
									<div class="col-12">
										<div class="card-body">
											...
											<div class="text-center mb-6">
												<a class="btn btn-primary" href="reg_usuario"
													rel="noopener noreferrer"><i
														class="fi fi-rr-user-add"></i>&nbsp;AÑADIR USUARIO</a>
											</div>


											<div class="table-responsive">
												<table class="table table-hover" id="user" cellspacing="0"
													style="width: 100%;">
													<thead>
														<tr>
															<th>Usuario</th>
																	...
																	<div class="btn-group">
																		...
																		<ul class="dropdown-menu dropdown-menu-end">
																			<li><a class="dropdown-item"
																					href="updcli.php?id=<?php echo $row['id_user']; ?>"><i
																						class="fi fi-rr-edit"></i>&nbsp;Editar
																					Usuario</a></li>
																		</ul>
																	</div>
																</td>
